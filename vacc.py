...
app.config(background = '#85351b')

## DEFAULT values
PINCODE = '110096'

# Color value reference
top_left_frame_bg  = "#8c4f2e"
top_right_frame_bg = '#e68c5c'
...
## TEXT BOX
result_box_avl = Text(app, height = 20, width = 8, bg='#85351b',fg='#ecfcff', relief=FLAT, font='verdana 10')
result_box_avl.place(x= 3 , y= 152)
result_box_cent = Text(app, height = 20, width = 30, bg='#85351b',fg='#ecfcff', relief=FLAT, font='verdana 10')
result_box_cent.place(x= 75 , y= 152)
result_box_age = Text(app, height = 20, width = 8, bg='#85351b',fg='#ecfcff', relief=FLAT, font='verdana 10')
result_box_age.place(x= 330 , y= 152)
result_box_vacc = Text(app, height = 20, width = 10, bg='#85351b',fg='#ecfcff', relief=FLAT, font='verdana 10')
result_box_vacc.place(x= 400 , y= 152)
result_box_D1 = Text(app, height = 20, width = 7, bg='#85351b',fg='#ecfcff', relief=FLAT, font='verdana 10')
result_box_D1.place(x= 490 , y= 152)
result_box_D2 = Text(app, height = 20, width = 7, bg='#85351b',fg='#ecfcff', relief=FLAT, font='verdana 10')
result_box_D2.place(x= 555 , y= 152)
result_box_D1_D2 = Text(app, height = 20, width = 7, bg='#85351b',fg='#ecfcff', relief=FLAT, font='verdana 10')
...
def insert_tomorrow_date():
   formatted_now = update_clock()
   date_text_var.set(formatted_now)
   today_date_chkbox['state'] = DISABLED
...
# Buttons
search_vaccine_image = PhotoImage(file='search-icon.png')
...
tomorrow_date_chkbox = Checkbutton(app, text='Tomorrow',
bg=top_right_frame_bg, variable=chkbox_tomorrow_var, onvalue=1,
                                  offvalue=0,
command=insert_tomorrow_date)
